...
namespace SpamFilter {
	...
	/// <summary>
	/// Interaction logic for EmailDisplayWindow.xaml
	/// </summary>
	public partial class EmailDisplayWindow : Window {
		...
		public EmailDisplayWindow(MainWindow parent, MessageHeaderInfo hinfo, OpenPop.Mime.Message msg) {
			InitializeComponent();
		...
		private void tbBtnForward_Click(object sender, RoutedEventArgs e) {

		}

		private void tbBtnBack_Click(object sender, RoutedEventArgs e) {
		...
		private void tbBtnRespond_Click(object sender, RoutedEventArgs e) {
