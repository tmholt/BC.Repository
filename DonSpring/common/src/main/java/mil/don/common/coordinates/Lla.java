...
public class Lla
{
    ...
    public Lla setLatitude(double latitude)
    {
    ...
    public Lla setLongitude(double longitude)
    {
    ...
    public Lla setAltitude(double altitude)
    {
    ...
    public Lla setAltType(AltitudeType altType)
    {
