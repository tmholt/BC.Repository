...
{
    public class PowerZones : List<PowerZone>
    {
        ...
        private void Initialize()
        {
            ...
            Add(new PowerZone(6, "Anaerobic Capacity", 111, 150, uint.MaxValue, uint.MaxValue, "Short (30 s to 3 min), high intensity intervals designed to increase anaerobic capacity. Heart rate generally not useful as guide to intensity due to non-steady-state nature of effort. Severe sensation of leg effort/fatigue, and conversation impossible. Consecutive days of extended level 6 training usually not attempted."));
            Add(new PowerZone(7, "Neuromuscular Power", uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, "Very short, very high intensity efforts (e.g., jumps, standing starts, short sprints) that generally place greater stress on musculoskeletal rather than metabolic systems. Power useful as guide, but only in reference to prior similar efforts, not TT pace."));
